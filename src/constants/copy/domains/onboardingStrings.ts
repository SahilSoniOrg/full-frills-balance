export const ONBOARDING_STRINGS = {
  ...
  continueToNext: 'Add expected income',
  continueToPayments: 'Add planned payments',
  continueToBoundaries: 'Set spending boundaries',
  ...
  skipForNow: 'Skip income',
  skipMoney: 'Skip current money',
  skipPayments: 'Skip planned payments',
  skipBudgets: 'Skip budgets',
