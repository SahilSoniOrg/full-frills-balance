...
export const UI_STRINGS = {
  ...
  onboarding: {
    ...
    splash: {
      eyebrow: 'A balance you can trust',
      title: 'See what’s actually available',
      subtitle: 'Know what remains after pending charges, bills, and money you’ve set aside.',
      inputLabel: 'What should we call you?',
      inputPlaceholder: 'Your name',
      btnGetStarted: 'Continue',
      dividerOr: 'OR',
  ...
  budget: {
    ...
    emptySubtitle: 'Budget limits you create will appear here.',
