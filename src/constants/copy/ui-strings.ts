...
export const UI_STRINGS = {
  ...
  transactionFlow: {
    ...
    enterConvertedOrWorkplaceRate: (currency: string) =>
    ...
    validation: {
      ...
      invalidDate: 'Choose a valid date before saving.',
      missingCurrency: 'Choose a valid currency before saving.',
      tooFewLines: 'Add at least two posting lines.',
      missingAccount: 'Choose an account for every posting line.',
      unknownAccount: 'Choose a valid account before saving.',
      duplicateLine: 'Posting lines must be unique.',
      missingDebit: 'Add a debit line before saving.',
      missingCredit: 'Add a credit line before saving.',
      missingExchangeRate: 'Enter an exchange rate for the foreign-currency line.',
      invalidExchangeRate: 'Enter a valid exchange rate.',
      accountMetadataMismatch: 'Refresh the account selection before saving.',
      unbalanced: 'Make sure the entry balances before saving.',
    },
    splitEntry: {
      title: 'Split entry',
      intro: 'Enter the full payment, then assign it to one or more categories.',
      fromAccount: 'Paid from',
      totalAmount: 'Payment total',
      categoriesTitle: 'Split between',
      category: 'Category',
      addSplit: 'Add split',
      removeSplit: 'Remove split',
      swipeToRemove: 'Swipe left on a split to remove it.',
      chooseCategory: 'Choose category',
      enterTotal: 'Enter payment total',
    ...
    simpleEntry: {
      toCategory: 'Spend on',
      fromAccount: 'Paid with',
      fromSource: 'Income from',
      toAccount: 'Received in',
      sourceAccount: 'Send from',
      destinationAccount: 'Deposit into',
      chooseAccount: 'Choose account',
      chooseCategory: 'Choose category',
      editConvertedAmount: (label: string, currency: string) =>
        `Edit ${label} amount in ${currency}`,
      defaultDescriptions: {
        transfer: 'Transfer',
  ...
  journalEntryModesHelp: {
    guided: {
      ...
      exampleItems: [
        'Choose Groceries for what you bought',
    ...
    split: {
      ...
      exampleItems: [
        'Choose the bank or wallet you paid from',
  ...
  advancedModeExplanation: {
    title: 'Advanced',
    intro:
      'Use Advanced when one entry needs several account movements. Add every affected account and choose whether each line is a debit or credit.',
    unlocks: 'Creates one custom journal entry; total debits must equal total credits.',
    exampleTitle: 'Example',
