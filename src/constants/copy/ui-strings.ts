...
export const UI_STRINGS = {
  ...
  advancedEntry: {
    ...
    intro: 'Add every account this entry touches. To must add up to From before you can save.',
    fromTitle: 'From',
    toTitle: 'To',
    addFrom: 'Add from',
    addTo: 'Add to',
    chooseAccount: 'Choose account',
    removeLine: 'Remove',
    swipeToRemove: 'Swipe left on a row to remove it.',
    moveToSide: (side: string) => `Move to ${side}`,
