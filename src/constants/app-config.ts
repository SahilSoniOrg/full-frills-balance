...
export const AppConfig = {
  ...
  strings: {
    ...
    dashboard: {
      ...
      petAndStreak: {
        cardTitle: 'Financial Companion & Streak',
        streakDays: (days: number) => `${days} Day${days === 1 ? '' : 's'} Streak`,
        todayLogged: 'Logged Today',
        checkInZeroSpend: 'Zero-Spend Check-In',
        ...
        modalTitle: 'Financial Pet & Streak Overview',
        petSectionTitle: 'Your Companion',
        streakSectionTitle: 'Daily Discipline & Streak',
        budgetHealthWeight: 'Budget Discipline',
        auditDisciplineWeight: 'Inbox Discipline',
        howToEarnXp: 'How to Earn XP & Maintain Health',
        tipLogTransaction: 'Log a transaction (+10 XP)',
        tipReviewSms: 'Triage & approve SMS transactions (+15 XP)',
        tipStreakMilestone: 'Reach daily streak milestones (+50 XP)',
        tipZeroSpend: 'Complete a Zero-Spend check-in on days with no expenses',
        streakActiveSubtitle:
          'Keep logging transactions or checking in daily to extend your streak!',
        streakLoggedMessage: 'You are all set for today! Your financial discipline is building up.',
      },
      hub: {
        title: 'Review',
        activeTab: 'Active',
