...
export const AppConfig = {
  ...
  strings: {
    ...
    journal: {
      ...
      reconciledUntilHere: (dateText: string) => `Reconciled until ${dateText}`,
      errors: {
    ...
    accounts: {
      ...
      reconciliation: {
        ...
        alert: {
          ...
          message: 'Match your current app balance with your official bank statement. This creates a permanent checkpoint for your records.',
          successMessage: 'Account reconciled successfully!',
          pendingTransactions: (count: number) => `There ${count === 1 ? 'is' : 'are'} ${count} pending ${count === 1 ? 'transaction' : 'transactions'} since your last reconciliation.`,
          matchingBalance: (balance: string) => `Target Balance: ${balance}`,
          guide: 'If this matches your bank statement, confirm below to mark it as reconciled.',
        },
      },
    },
    advancedEntry: {
