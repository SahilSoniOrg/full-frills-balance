            ...
            <View style={{ gap: Spacing.md }}>
              <View style={styles.statRow}>
                <AppText variant="body" weight="medium">
                  {AppConfig.strings.maintenance.stats.accounts}
                </AppText>
              ...
              <View style={styles.statRow}>
                <AppText variant="body" weight="medium">
                  {AppConfig.strings.maintenance.stats.journals}
                </AppText>
                <AppText variant="body" color="success" weight="bold">
                  {importStats.journals}
                </AppText>
              </View>
              <View style={styles.statRow}>
                <AppText variant="body" weight="medium">
                  {AppConfig.strings.maintenance.stats.transactions}
                </AppText>
                <AppText variant="body" color="success" weight="bold">
                  {importStats.transactions}
                </AppText>
              </View>
              {typeof importStats.budgets === 'number' && importStats.budgets > 0 && (
                <View style={styles.statRow}>
                  <AppText variant="body" weight="medium">
                    {AppConfig.strings.maintenance.stats.budgets}
                  </AppText>
                  <AppText variant="body" color="success" weight="bold">
                    {importStats.budgets}
                  </AppText>
              ...
              {typeof importStats.auditLogs === 'number' && importStats.auditLogs > 0 && (
                <View style={styles.statRow}>
                  <AppText variant="body" weight="medium">
                    {AppConfig.strings.maintenance.stats.auditLogs}
                  </AppText>
                  <AppText variant="body" color="success" weight="bold">
                    {importStats.auditLogs}
                  </AppText>
                </View>
              )}
              {typeof importStats.plannedPayments === 'number' &&
                importStats.plannedPayments > 0 && (
                  <View style={styles.statRow}>
                    <AppText variant="body" weight="medium">
                      {AppConfig.strings.maintenance.stats.plannedPayments}
                    </AppText>
                    <AppText variant="body" color="success" weight="bold">
                      {importStats.plannedPayments}
                    </AppText>
                  </View>
                )}
              {importStats.skippedTransactions > 0 && (
                <View style={styles.statRow}>
                  <AppText variant="body" color="warning">
                    {AppConfig.strings.maintenance.stats.skippedItems}
                  </AppText>
                  <AppText variant="body" color="warning" weight="bold">
