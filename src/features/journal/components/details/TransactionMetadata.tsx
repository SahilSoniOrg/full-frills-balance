...
export const TransactionMetadata = React.memo(
  ({ formattedDate, notesText, onHistoryPress }: TransactionMetadataProps) => {
...
TransactionMetadata.displayName = 'TransactionMetadata';
