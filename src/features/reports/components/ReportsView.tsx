...
export function ReportsView(vm: ReportsViewModel) {
  ...
  const renderOverview = () => (
    <>
      <AppCard
        style={[
          styles.chartCard,
          { zIndex: selectedNetWorthIndex !== undefined ? 100 : 50, overflow: 'visible' },
        ]}
        padding="lg"
      >
      ...
      <AppCard
        style={[
          styles.chartCard,
          { zIndex: selectedIncomeExpenseIndex !== undefined ? 100 : 40, overflow: 'visible' },
        ]}
        padding="lg"
      >
        <View style={styles.chartContainer}>
      ...
      <AppCard style={[styles.chartCard, { zIndex: 20, overflow: 'visible' }]} padding="lg">
        <SankeyChart nodes={sankeyData.nodes} links={sankeyData.links} width={CHART_WIDTH} />
      </AppCard>
    </>
  );
  ...
  const renderWealthTooltip = useCallback(
    ...
    [vm, theme, CHART_WIDTH, getWealthTooltipPosition],
  );
  ...
  const renderWealth = () => (
    <>
      ...
      <AppCard
        style={[
          styles.chartCard,
          { zIndex: vm.selectedNetWorthIndex !== undefined ? 100 : 50, overflow: 'visible' },
        ]}
        padding="lg"
      >
        <View style={styles.headerRow}>
      ...
      <AppCard
        style={[
          styles.chartCard,
          { zIndex: vm.selectedWealthIndex !== undefined ? 100 : 40, overflow: 'visible' },
        ]}
        padding="lg"
      >
        <AreaChart
