    ...
    <Screen title="Appearance" showBack={true} scrollable withPadding edges={['top', 'bottom']}>
      <View style={styles.container}>
        ...
        <View style={styles.optionsContainer}>
          <Pressable onPress={() => vm.setThemeId(ThemeIds.DEEP_SPACE)}>
            ...
            >
              <View style={styles.optionContent}>
                ...
                {vm.themeId === ThemeIds.DEEP_SPACE && (
                  <View
                    style={[
                      styles.radio,
          ...
          <Pressable onPress={() => vm.setThemeId(ThemeIds.GOLD_OBSIDIAN)}>
            <AppCard
              elevation={vm.themeId === ThemeIds.GOLD_OBSIDIAN ? 'sm' : 'none'}
              style={[
                styles.optionCard,
                { borderWidth: vm.themeId === ThemeIds.GOLD_OBSIDIAN ? 2 : 1 },
                {
                  borderColor: vm.themeId === ThemeIds.GOLD_OBSIDIAN ? theme.primary : theme.border,
                },
              ]}
            >
              <View style={styles.optionContent}>
                ...
                {vm.themeId === ThemeIds.GOLD_OBSIDIAN && (
                  <View
                    style={[
                      styles.radio,
                      { borderColor: theme.primary, backgroundColor: theme.primary },
