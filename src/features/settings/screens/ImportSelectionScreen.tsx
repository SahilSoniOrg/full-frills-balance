...
export default function ImportSelectionScreen() {
  ...
  if (isImporting) {
    return (
      <Screen title="Importing Data" showBack={false} withPadding>
        <View style={[styles.container, styles.progressContainer]}>
          <View style={styles.progressAnimationPlaceholder}>
            <AppText variant="heading" style={{ fontSize: 48, marginBottom: Spacing.md }}>
              ⏳
            </AppText>
          </View>
          ...
          <AppText
            variant="caption"
            color="secondary"
            style={{ marginTop: Spacing.xxl * 2, textAlign: 'center', opacity: Opacity.heavy }}
          >
  ...
  return (
    <Screen title={AppConfig.strings.settings.importTitle} showBack={true} scrollable withPadding>
