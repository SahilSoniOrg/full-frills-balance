...
export function SettingsMenuItem({
    ...
    const renderLeftIcon = () => {
        ...
        if (typeof leftIcon === 'string') {
            ...
            return (
                <Box
                    background={danger ? 'errorSoft' : 'surfaceSecondary'}
                    borderRadius="r2"
                    padding="xs"
                    alignItems="center"
                ...
                >
                    {isActualIcon ? (
                        ...
                        <AppText variant="body" style={{ fontSize: 16 }}>{leftIcon}</AppText>
                    )}
                </Box>
            );
        }
    ...
    return (
        <TouchableOpacity
            ...
            activeOpacity={0.7}
        >
            <Inline align="center" justify="space-between" paddingHorizontal="md" paddingVertical="sm" space="md">
                ...
                <Inline align="center" space="xs">
                    {loading ? (
                        <Box padding="xs">
                            <AppIcon name="refresh" size={16} color={theme.textSecondary} style={{ opacity: 0.5 }} />
                        </Box>
                    ) : (
                        rightContent
                    )}
