 ...
 * 2. Launches the app into the foreground via deep link `fullfrillsbalance://sms-inbox?approve=<recordId>`.
...
class SmsQuickImportReceiver : BroadcastReceiver() {
  ...
  override fun onReceive(context: Context, intent: Intent) {
    ...
    val deepLinkUri = Uri.parse("$APP_SCHEME://sms-inbox?approve=$recordId")
